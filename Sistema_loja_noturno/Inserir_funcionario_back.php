...
$inserir = "INSERT INTO tb_funcionario (fun_codigo,fun_nome,fun_endereco,fun_numero,fun_complemento,fun_bairro,fun_cidade,fun_uf,fun_cnpjcpf,fun_rgie,fun_sexo,fun_nascimento,fun_telefone,fun_celular,fun_email,fun_salario) VALUES ('$fun_codigo1','$fun_nome1','$fun_endereco1','$fun_numero1','$fun_complemento1','$fun_bairro1','$fun_cidade1','$fun_uf1','$fun_cnpjcpf1','$fun_rgie1','$fun_sexo1','$fun_nascimento1','$fun_telefone1','$fun_celular1','$fun_email1','$fun_salario1')";
