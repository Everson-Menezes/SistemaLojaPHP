...
<?php
include "conexao.php";
$result = mysqli_query("select * from tb_compras", $db);
echo "<center><table border='1'>
<tr>
	<td><h3>Código Compra</h3></td>
	<td><h3>Código Tipo de Pagamenro</h3></td>
	<td><h3>Código Fornecedor</h3></td>
	<td><h3>Código Nota</h3></td>
	<td><h3>Data Compra</h3></td>
	<td><h3>Valor</h3></td>
